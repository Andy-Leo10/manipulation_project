...
int main(int argc, char **argv) {
  ...
  target_pose1.orientation.x = -0.617;
  target_pose1.orientation.y = 0.787;
  target_pose1.orientation.z = 0.001;
  target_pose1.orientation.w = -0.005;
  target_pose1.position.x = 0.3403;
  target_pose1.position.y = -0.0193;
